...
public abstract class ProductExecutionStrategy extends ExecutionStrategy {

    private static final Logger log = LoggerFactory.getLogger(ProductExecutionStrategy.class);
    private static final Logger logNotSafe = LogKit.getNotPrivacySafeLogger(ProductExecutionStrategy.class);
     ...
     */
    protected ProductExecutionStrategy() {
     ...
     */
    protected ProductExecutionStrategy(DataFetcherExceptionHandler dataFetcherExceptionHandler) {
     ...
     * #fetchField followed by #completeField and the completed {@link FieldValueInfo} is returned.
     * <p>
     * An execution strategy can iterate the fields to be executed and call this method for each one
     * <p>
     * Graphql fragments mean that for any give logical field can have one or more {@link Field} values associated with it
